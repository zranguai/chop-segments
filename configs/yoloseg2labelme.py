...
class YOLO2Labelme(object):
    ...
    def __init__(self, txt_dir, img_dir, json_dir, label_id_map):
    ...
    def convert(self):
        ...
        pbar = tqdm(txt_names, total=len(txt_names), bar_format=TQDM_BAR_FORMAT)

        for txt_name in pbar:
            ...
            # print(f"{txt_name} IS CONVERT DONE")  # print for debug


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--txt_dir', type=str, default=r'labels/train2017',
                        help='yolov8-seg txt files dir')
    parser.add_argument('--img_dir', type=str,
                        default=r'images/train2017',
                        help='yolov8-seg image files dir')
    parser.add_argument('--json_dir', type=str,
                        default=r'labelme_jsons',
