...
from configs.json2yolo_utils import *
...
def convert_coco_json(json_dir='../coco/annotations/', use_segments=False, cls91to80=False,
                      output_dir="cut_image/txt_cut4", coco_img_dir="cut_image/coco_cut4/train"
                      ):
    ...
    for json_file in sorted(Path(json_dir).resolve().glob('*.json')):
        ...
        for categorie in data["categories"]:
            label_id = categorie["id"] - 1  # label_id_map id从0开始
            label_name = categorie["name"]
            label_id_map[label_id] = label_name
        return label_id_map
...
if __name__ == '__main__':
    ...
    if source == 'COCO':
        convert_coco_json('./../cut_image/coco_cut4/annotations',  # directory with *.json
                          use_segments=True,
                          cls91to80=False,
                          output_dir="./../cut_image/txt_cut4",
                          coco_img_dir="./../cut_image/coco_cut4/train"
                          )
